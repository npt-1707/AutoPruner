...
class BaggingModel(EnsembleModel):
    def __init__(self, base_model, n_estimators=10, estimator_params=None):
        super(BaggingModel, self).__init__(base_model, n_estimators, estimator_params)    
...
class GradientBoostingModel(nn.Module):
    def __init__(self, base_model, n_estimators=10, estimator_params=None):
        super(GradientBoostingModel, self).__init__(base_model, n_estimators, estimator_params)
